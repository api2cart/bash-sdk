...
"nopcommerce_secret=:[QUERY] nopCommerce webhook signing secret generated by the Api2Cart.Connector plugin. Optional when connecting a store, but required to receive webhooks from it."
...
"jumpseller_client_id=:[QUERY] Jumpseller OAuth2 Client ID"
"jumpseller_client_secret=:[QUERY] Jumpseller OAuth2 Client Secret"
"jumpseller_refresh_token=:[QUERY] Jumpseller OAuth2 refresh token"
"jumpseller_login=:[QUERY] Jumpseller API login"
"jumpseller_authtoken=:[QUERY] Jumpseller API auth token"
...
"send_notifications=true:[QUERY] Send notifications to customer after order status was changed"
          "send_notifications=false:[QUERY] Send notifications to customer after order status was changed"
